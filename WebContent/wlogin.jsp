		...
		<tr>
			...
			<td width="70%">
				<table width="100%" border="0" align="center" background="images/2.jpg">
					<tr>
						<td align="center">
							<form name="form1" action=WorkUserServlet?action=wlogin method="post" onSubmit="return check(this)">
								工&nbsp;&nbsp;&nbsp;&nbsp;号:&nbsp;<input type="text" name="worknum"><br><br><br>
